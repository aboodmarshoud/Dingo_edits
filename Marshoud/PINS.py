...
class ServoParams:
    def __init__(self):
        ...
        self.micros_per_rad =  11.333 * 180.0 / np.pi  # Must be calibrated

        # The neutral angle of the joint relative to the modeled zero-angle in degrees, for each joint
        self.neutral_angle_degrees = np.array([[7, 4, -3, -3], [110, 131, 84, 6], [-53, 31, -64, -20]])
...
class Configuration:
    def __init__(self):
        ...
        self.ps4_color = {"red": 0, "blue": 0, "green": 255}    
        self.ps4_deactivated_color = {"red": 0, "blue": 0, "green": 50} 
